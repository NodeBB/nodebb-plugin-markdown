...
<form class="form">
	<div class="form-group">
		<label for="gfm">
			<input type="checkbox" data-field="markdown:options:gfm" id="gfm" />
			Use <a href="http://github.github.com/github-flavored-markdown/">Github flavoured Markdown</a>
		</label>
	</div>
	<div class="form-group">
		<label for="highlight">
			<input type="checkbox" data-field="markdown:options:highlight" id="highlight" />
			Automatically detect and highlight code blocks
		</label>
	</div>
	<div class="form-group">
		<label for="tables">
			<input type="checkbox" data-field="markdown:options:tables" id="tables" />
			Parse <a href="https://github.com/adam-p/markdown-here/wiki/Markdown-Cheatsheet#wiki-tables">GFM Table Syntax</a>
		</label>
	</div>
	<div class="form-group">
		<label for="breaks">
			<input type="checkbox" data-field="markdown:options:breaks" id="breaks" />
			Treat newlines as single line breaks
		</label>
	</div>
	<div class="form-group">
		<label for="pedantic">
			<input type="checkbox" data-field="markdown:options:pedantic" id="pedantic" />
			Be as true to the Markdown specification as possible (in most cases, this is not required)
		</label>
	</div>
	<div class="form-group">
		<label for="sanitize">
			<input type="checkbox" data-field="markdown:options:sanitize" id="sanitize" />
			Sanitize HTML
		</label>
	...
	<div class="form-group">
		<label for="smartLists">
			<input type="checkbox" data-field="markdown:options:smartLists" id="smartLists" />
			Use smarter list behviour
		</label>
	</div>
	<div class="form-group">
		<label for="smartypants">
			<input type="checkbox" data-field="markdown:options:smartypants" id="smartypants" />
	...
	<div class="form-group">
		...
		<input placeholder="lang-" type="text" data-field="markdown:options:langPrefix" id="langPrefix" />
	</div>
